...
d = {
    "drug": pd.Series(
        ["Ecstasy", "Ecstasy", "Ecstasy", "Alcohol", "Alcohol", "Alcohol"], index=["0", "1", "2", "3", "4", "5"]
    ),
...
variables = [
    {"name": "drug", "data type": "nominal", "categories": ["Ecstasy", "Alcohol"]},
    {"name": "sundayBDI", "data type": "ratio"},
    {"name": "wedsBDI", "data type": "ratio"},
    {"name": "BDIchange", "data type": "ratio"},
]
...
assumptions = {"Type I (False Positive) Error Rate": 0.01}
