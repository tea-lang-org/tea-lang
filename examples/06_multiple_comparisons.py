"""Multiple group comparisons — Kendall tau with two predictions.

String syntax:      tea.hypothesize(['Position', 'Creativity'], ['Position:1 > 6', 'Position:1 > 2'])
Structured syntax:  tea.hypothesize(['Position', 'Creativity'], [tea.compare(1, '>', 6), tea.compare(1, '>', 2)])

Expected outcome: Kendall's tau, Spearman's rho

Run:  poetry run python examples/06_multiple_comparisons.py
"""
import os
import tea
