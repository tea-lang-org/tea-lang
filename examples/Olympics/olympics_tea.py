...
test_statistic = 46021305.50000
p_value = 1.00000
adjusted_p_value = 1.00000
alpha = 0.05
dof = 18793
Effect size:
A12 = 0.53830
Null hypothesis = There is no difference in medians between Sport = Swimming and Sport = Wrestling on Weight.
Interpretation = t(18793) = 46021305.50000, p = 1.00000. Fail to reject the null hypothesis at alpha = 0.05. There is no difference in medians between Sport = Swimming and Sport = Wrestling on Weight.The effect size is A12 = 0.53830. The effect size is the magnitude of the difference, which gives a holistic view of the results [1].
...
Interpretation = t(18793) = 72.86194, p = 0.00000. Reject the null hypothesis at alpha = 0.05. There is a difference in medians of Weight for at least one of Sport = Swimming, Wrestling.
...
***Test results:
name = Mann Whitney U Test
test_statistic = 7704479516.00000
p_value = 1.00000
adjusted_p_value = 1.00000
alpha = 0.05
dof = 141449
...
Interpretation = t(141449) = 7704479516.00000, p = 1.00000. Reject the null hypothesis at alpha = 0.05. The median of Weight for Sex = F is significantly less than the median for Sex = M. The effect size is A12 = 0.15910. The effect size is the magnitude of the difference, which gives a holistic view of the results [1].
[1] Sullivan, G. M., & Feinn, R. (2012). Using effect size—or why the P value is not enough. Journal of graduate medical education, 4(3), 279-282.
...
Interpretation = t(141449) = 61996.35428, p = 0.00000. Fail to reject the null hypothesis at alpha = 0.05. There is no difference in medians between Sex = M, F on Weight.'''
