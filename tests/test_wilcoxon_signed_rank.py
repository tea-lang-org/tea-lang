...
def test_wilcoxon_signed_rank_0():
    ...
    variables = [
        {"name": "Person", "data type": "ratio"},
        {"name": "Side", "data type": "nominal", "categories": ["Right", "Left"]},
...
def test_wilcoxon_signed_rank_1():
    ...
    variables = [
        {"name": "Subject", "data type": "ratio"},
        {"name": "Source", "data type": "nominal", "categories": ["Memory", "Median"]},
        {"name": "Score", "data type": "ratio"},
    ]
    experimental_design = {
        "study type": "experiment",
...
def test_wilcoxon_signed_rank_2():
    ...
    variables = [
        {"name": "Couple", "data type": "ratio"},
        {"name": "Person", "data type": "nominal", "categories": ["Wife", "Husband"]},
        {"name": "Score", "data type": "ratio"},
    ]
    experimental_design = {
