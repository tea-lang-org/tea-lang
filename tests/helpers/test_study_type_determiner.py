...
class StudyTypeDeterminerTests(unittest.TestCase):
    ...
    def test_method_should_return_experiment_identifier_when_non_explicit_type_and_existing_contributor_and_outcome(self):
        design = {
            contributor_identifier: 'x',
            outcome_identifier: 'y'
        }
