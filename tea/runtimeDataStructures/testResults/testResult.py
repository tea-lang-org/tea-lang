...
class TestResult(Value): 
    ...
    def __init__(self, name: str, test_statistic: Any, p_value: float, prediction: Relationship, alpha: float, dof: int, dataset: Dataset, vars: List[VarData],
        ...
        self.table = table 
        self.group_descriptive_statistics = group_descriptive_statistics

        self.adjust_p_val()
        self.null_hypothesis = self.get_null_hypothesis()
        self.interpretation = self.generate_interpretation()
        self.template_text = self.generate_template_text()
        self.visualization = self.generate_visualization()
        self.assumptions = None # Until it gets set
    ...
    def set_assumptions(self, assumptions: List[str]): 
        self.assumptions = assumptions

    def get_null_hypothesis(self) -> str:
    ...
    # def generate_adjusted_p_val(self, adjusted_p_value): 
    #     self.self.adjusted_p_value = attr.ib()
