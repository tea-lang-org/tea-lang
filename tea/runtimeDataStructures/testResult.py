...
# @attr.s(init=False)
# class PairedStudentsTResult(TestResult):
#     dof = attr.ib()
#     prediction = attr.ib()
#     null_hypothesis = attr.ib(default="There is no difference in group means")
#     interpretation = attr.ib(default=None)
...
#     def __init__(self, test_statistic, p_value, dof, prediction):
#         # call Super class
#         TestResult.__init__(self, name="Paired Student\'s T Test", test_statistic=test_statistic, p_value=p_value)
#         self.dof = dof
#         self.prediction = prediction
...
#     def __init__(self, test_statistic, p_value, dof, prediction):
#         # call Super class
#         TestResult.__init__(self, name="Welch\'s Test", test_statistic=test_statistic, p_value=p_value)
#         self.dof = dof
#         self.prediction = prediction
